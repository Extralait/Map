...
`passport_data` | ***object(user_passport)*** | Объект с паспортными данными пользователя
...
`verify_status` | ***
str*** | :x: | :heavy_check_mark: | :x: | Статус верификации пользователя (not_verified, moderation, verified)
...
#### Получение популярных художником
